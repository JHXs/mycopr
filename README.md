...
| `linux-enable-ir-emitter` | [![Copr build status](https://copr.fedorainfracloud.org/coprs/ikunji/linux-enable-ir-emitter/package/linux-enable-ir-emitter/status_image/last_build.png)](https://copr.fedorainfracloud.org/coprs/ikunji/linux-enable-ir-emitter/package/linux-enable-ir-emitter/) |
...
| `computer-use-linux` | [![Copr build status](https://copr.fedorainfracloud.org/coprs/ikunji/computer-use-linux/package/computer-use-linux/status_image/last_build.png)](https://copr.fedorainfracloud.org/coprs/ikunji/computer-use-linux/package/computer-use-linux/) |
| `blesh` | [![Copr build status](https://copr.fedorainfracloud.org/coprs/ikunji/mycopr/package/blesh/status_image/last_build.png)](https://copr.fedorainfracloud.org/coprs/ikunji/mycopr/package/blesh/) |
...
| `realitlscanner` | [![Copr build status](https://copr.fedorainfracloud.org/coprs/ikunji/realitytools/package/realitlscanner/status_image/last_build.png)](https://copr.fedorainfracloud.org/coprs/ikunji/realitytools/package/realitlscanner/) |
| `realitychecker` | [![Copr build status](https://copr.fedorainfracloud.org/coprs/ikunji/realitytools/package/realitychecker/status_image/last_build.png)](https://copr.fedorainfracloud.org/coprs/ikunji/realitytools/package/realitychecker/) |
